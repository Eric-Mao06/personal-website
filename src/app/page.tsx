...
export default function Home() {
  ...
  return (
    <PageLayout>
        ...
        <div className="pt-4">
          ...
          <Link href="https://waterloo.uselinkd.com" target="_blank" rel="noopener noreferrer" className="block">
            <div className="flex justify-between py-3 border-t border-neutral-200 hover:bg-neutral-50 transition-colors">
              <div className="font-medium text-black flex items-center">Serendipity <ArrowUpRight className="ml-1" size={16} /></div>
              <div className="max-w-m text-right">
          ...
          <Link href="https://github.com/Eric-Mao06/AiWantItThatWay" target="_blank" rel="noopener noreferrer" className="block">
            <div className="flex justify-between py-3 border-t border-neutral-200 hover:bg-neutral-50 transition-colors">
              <div className="font-medium text-black flex items-center">AiWantItThatWay <ArrowUpRight className="ml-1" size={16} /></div>
          ...
          <Link href="https://berkeley.uselinkd.com" target="_blank" rel="noopener noreferrer" className="block">
            <div className="flex justify-between py-3 border-t border-neutral-200 hover:bg-neutral-50 transition-colors">
              <div className="font-medium text-black flex items-center">Linkd Alums <ArrowUpRight className="ml-1" size={16} /></div>
              <div className="max-w-md text-right">
          ...
          <Link href="/carbon_credits.pdf" target="_blank" rel="noopener noreferrer" className="block">
            <div className="flex justify-between py-3 border-t border-neutral-200 hover:bg-neutral-50 transition-colors">
              <div className="font-medium text-black flex items-center">Big Data <ArrowUpRight className="ml-1" size={16} /></div>
              <div className="max-w-md text-right">
      ...
      <div className="layout-md mt-10 mb-5 w-full">
        <Image
          src="/photo.jpg"
